var v_createQueryTabFunction = function(p_table, p_tab_db_id) {
  ...
  "<button id='bt_history_" + v_tab.id + "' class='btn btn-sm omnidb__theme__btn--primary omnidb__tab-actions__btn' title='Command History' onclick='showCommandList();'><i class='fas fa-list fa-light'></i></button>" +
  "<button id='bt_explain_" + v_tab.id + "' class='dbms_object postgresql_object btn btn-sm omnidb__theme__btn--primary omnidb__tab-actions__btn' onclick='getExplain(0)' title='Explain' style='display: none;'><i class='fas fa-search fa-light'></i></button>" +
  "<button id='bt_analyze_" + v_tab.id + "' class='dbms_object postgresql_object btn btn-sm omnidb__theme__btn--primary omnidb__tab-actions__btn' onclick='getExplain(1)' title='Explain Analyze' style='display: none;'><i class='fas fa-search-plus fa-light'></i></button>" +
  ...
  "<button id='bt_fetch_more_" + v_tab.id + "' class='btn btn-sm omnidb__theme__btn--primary omnidb__tab-actions__btn' title='Run' style='display: none; ' onclick='querySQL(1);'>Fetch more</button>" +
  "<button id='bt_fetch_all_" + v_tab.id + "' class='btn btn-sm omnidb__theme__btn--primary omnidb__tab-actions__btn' title='Run' style='margin-left: 5px; display: none; ' onclick='querySQL(2);'>Fetch all</button>" +
  ...
  "<button id='bt_rollback_" + v_tab.id + "' class='dbms_object dbms_object_hidden postgresql_object btn btn-sm omnidb__theme__btn--primary omnidb__tab-actions__btn' title='Run' style='margin-left: 5px; display: none; ' onclick='querySQL(4);'>Rollback</button>" +
  ...
  v_data_tab.elementDiv.innerHTML = "<div id='div_result_" + v_tab.id + "' class='query_result' style='width: 100%; overflow: hidden;'></div>";
  ...
  v_messages_tab.elementDiv.innerHTML = "<div id='div_notices_" + v_tab.id + "' class='query_result' style='width: 100%; line-height: 16px; user-select: initial;'></div>";
