...
base_urlpatterns = [
    ...
    url(r'^update_saved_monitor_unit_interval/', views.monitor_dashboard.update_saved_monitor_unit_interval, name='update_saved_monitor_unit_interval'),
       ...
       # TREE_mssql
       url(r'^get_tree_info_mssql/', views.tree_mssql.get_tree_info,
           name='get_tree_info'),
       url(r'^get_tables_mssql/', views.tree_mssql.get_tables, name='get_tables'),
       url(r'^get_columns_mssql/', views.tree_mssql.get_columns,
           name='get_columns'),
       url(r'^get_pk_mssql/', views.tree_mssql.get_pk, name='get_pk'),
       url(r'^get_pk_columns_mssql/', views.tree_mssql.get_pk_columns,
           name='get_pk_columns'),
       url(r'^get_fks_mssql/', views.tree_mssql.get_fks, name='get_fks'),
       url(r'^get_fks_columns_mssql/', views.tree_mssql.get_fks_columns,
           name='get_fks_columns'),
       url(r'^get_uniques_mssql/', views.tree_mssql.get_uniques,
           name='get_uniques'),
       url(r'^get_uniques_columns_mssql/', views.tree_mssql.get_uniques_columns,
           name='get_uniques_columns'),
       url(r'^get_indexes_mssql/', views.tree_mssql.get_indexes,
           name='get_indexes'),
       url(r'^get_indexes_columns_mssql/', views.tree_mssql.get_indexes_columns,
           name='get_indexes_columns'),
       # url(r'^get_triggers_mssql/', views.tree_mssql.get_triggers, name='get_triggers'),
       # url(r'^get_partitions_mssql/', views.tree_mssql.get_partitions, name='get_partitions'),
       url(r'^get_functions_mssql/', views.tree_mssql.get_functions,
           name='get_functions'),
       url(r'^get_function_fields_mssql/', views.tree_mssql.get_function_fields,
           name='get_function_fields'),
       url(r'^get_function_definition_mssql/',
           views.tree_mssql.get_function_definition,
           name='get_function_definition'),
       url(r'^get_procedures_mssql/', views.tree_mssql.get_procedures,
           name='get_procedures'),
       url(r'^get_procedure_fields_mssql/', views.tree_mssql.get_procedure_fields,
           name='get_procedure_fields'),
       url(r'^get_procedure_definition_mssql/',
           views.tree_mssql.get_procedure_definition,
           name='get_procedure_definition'),
       # url(r'^get_function_debug_mssql/', views.tree_mssql.get_function_debug, name='get_function_debug'),
       # url(r'^get_triggerfunctions_mssql/', views.tree_mssql.get_triggerfunctions, name='get_triggerfunctions'),
       # url(r'^get_triggerfunction_definition_mssql/', views.tree_mssql.get_triggerfunction_definition, name='get_triggerfunction_definition'),
       # url(r'^get_sequences_mssql/', views.tree_mssql.get_sequences, name='get_sequences'),
       url(r'^get_views_mssql/', views.tree_mssql.get_views, name='get_views'),
       url(r'^get_views_columns_mssql/', views.tree_mssql.get_views_columns,
           name='get_views_columns'),
       url(r'^get_view_definition_mssql/', views.tree_mssql.get_view_definition,
           name='get_view_definition'),
       url(r'^get_databases_mssql/', views.tree_mssql.get_databases,
           name='get_databases'),
       url(r'^get_roles_mssql/', views.tree_mssql.get_roles, name='get_roles'),
       url(r'^kill_backend_mssql/', views.tree_mssql.kill_backend,
           name='kill_backend'),
       url(r'^get_properties_mssql/', views.tree_mssql.get_properties,
           name='get_properties'),
       url(r'^template_select_mssql/', views.tree_mssql.template_select,
           name='template_select'),
       url(r'^template_insert_mssql/', views.tree_mssql.template_insert,
           name='template_insert'),
       url(r'^template_update_mssql/', views.tree_mssql.template_update,
