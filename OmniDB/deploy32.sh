...
cp /usr/lib/i386-linux-gnu/libgconf-2.so.4 omnidb-build/omnidb-app/libgconf-2.so.4
chmod 755 omnidb-build/omnidb-app/libgconf-2.so.4
cp /usr/lib/i386-linux-gnu/libgconf-2.so.4 omnidb-build/omnidb-app/cefpython3/libgconf-2.so.4
chmod 755 omnidb-build/omnidb-app/cefpython3/libgconf-2.so.4
echo "Done."

echo -n "Renaming bundles... "
mv omnidb-build/omnidb-server omnidb-build/omnidb-server-32bits_$VERSION
mv omnidb-build/omnidb-app omnidb-build/omnidb-app-32bits_$VERSION
echo "Done."

echo "Generating zip packages... "
cd omnidb-build
tar -czvf omnidb-server-32bits_$VERSION.tar.gz omnidb-server-32bits_$VERSION
tar -czvf omnidb-app-32bits_$VERSION.tar.gz omnidb-app-32bits_$VERSION
cd ..
echo "Done"
