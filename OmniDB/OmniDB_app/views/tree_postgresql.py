    ...
    try:
        v_return['v_data'] = {
            ...
            'v_database_return': {
                ...
                'create_eventtrigger': v_database.TemplateCreateTrigger().v_text,
                'alter_eventtrigger': v_database.TemplateAlterTrigger().v_text,
                'enable_eventtrigger': v_database.TemplateEnableTrigger().v_text,
                'disable_eventtrigger': v_database.TemplateDisableTrigger().v_text,
                'drop_eventtrigger': v_database.TemplateDropTrigger().v_text,
