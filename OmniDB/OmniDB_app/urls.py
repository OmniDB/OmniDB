...
urlpatterns = [
    ...
    url(r'^get_pglogical_nodes_postgresql/', views.tree_postgresql.get_pglogical_nodes, name='get_pglogical_nodes_postgresql'),
    url(r'^get_pglogical_interfaces_postgresql/', views.tree_postgresql.get_pglogical_interfaces, name='get_pglogical_interfaces_postgresql'),
    url(r'^get_pglogical_replicationsets_postgresql/', views.tree_postgresql.get_pglogical_replicationsets, name='get_pglogical_replicationsets_postgresql'),
    url(r'^get_pglogical_repset_tables_postgresql/', views.tree_postgresql.get_pglogical_repset_tables, name='get_pglogical_repset_tables_postgresql'),
    url(r'^get_pglogical_repset_seqs_postgresql/', views.tree_postgresql.get_pglogical_repset_seqs, name='get_pglogical_repset_seqs_postgresql'),
    url(r'^get_pglogical_subscriptions_postgresql/', views.tree_postgresql.get_pglogical_subscriptions, name='get_pglogical_subscriptions_postgresql'),
    url(r'^get_pglogical_subscription_repsets_postgresql/', views.tree_postgresql.get_pglogical_subscription_repsets, name='get_pglogical_subscription_repsets_postgresql'),
