...
su - postgres -c "/usr/local/pgsql/bin/initdb -D /usr/local/pgsql/data_datanode_1 --nodename datanode_1"

PG_CONF="/usr/local/pgsql/data_datanode_1/postgresql.conf"
PG_HBA="/usr/local/pgsql/data_datanode_1/pg_hba.conf"
PG_DIR="/usr/local/pgsql/data_datanode_1"
...
echo "pooler_port = 40101" >> "$PG_CONF"
echo "gtm_host = '192.168.56.105'" >> "$PG_CONF"
...
su - postgres -c "/usr/local/pgsql/bin/postgres --datanode -D /usr/local/pgsql/data_datanode_1 >logfile 2>&1 &"
sleep 30
