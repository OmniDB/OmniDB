...
namespace OmniDatabase
{
	...
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="OmniDB.Database.MySQL"/> class.
		/// </summary>
		...
		public MySQL (string p_conn_id, string p_server, string p_port, string p_service, string p_user, string p_password)
			: base ("mysql",p_conn_id)
		{
			...
			v_connection = new Spartacus.Database.Mysql (p_server, p_port, p_service, p_user, p_password);
